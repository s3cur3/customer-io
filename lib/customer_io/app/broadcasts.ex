defmodule CustomerIo.App.Broadcasts do
  @moduledoc """
  ...
  def broadcast_action_links(broadcast_id, action_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {CustomerIo.App.Broadcasts, :broadcast_action_links},
  ...
  def broadcast_action_metrics(broadcast_id, action_id, opts \\ []) do
    ...
    client.request(%{
      args: [broadcast_id: broadcast_id, action_id: action_id],
      call: {CustomerIo.App.Broadcasts, :broadcast_action_metrics},
  ...
  def broadcast_actions(broadcast_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {CustomerIo.App.Broadcasts, :broadcast_actions},
  ...
  def broadcast_errors(broadcast_id, trigger_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {CustomerIo.App.Broadcasts, :broadcast_errors},
  ...
  def broadcast_links(broadcast_id, opts \\ []) do
    ...
    client.request(%{
      args: [broadcast_id: broadcast_id],
      call: {CustomerIo.App.Broadcasts, :broadcast_links},
  ...
  def broadcast_messages(broadcast_id, opts \\ []) do
    ...
    client.request(%{
      args: [broadcast_id: broadcast_id],
      call: {CustomerIo.App.Broadcasts, :broadcast_messages},
  ...
  def broadcast_metrics(broadcast_id, opts \\ []) do
    ...
    client.request(%{
      args: [broadcast_id: broadcast_id],
      call: {CustomerIo.App.Broadcasts, :broadcast_metrics},
  ...
  def broadcast_status(broadcast_id, trigger_id, opts \\ []) do
    ...
    client.request(%{
      args: [broadcast_id: broadcast_id, trigger_id: trigger_id],
      call: {CustomerIo.App.Broadcasts, :broadcast_status},
  ...
  def get_broadcast(broadcast_id, opts \\ []) do
    ...
    client.request(%{
      args: [broadcast_id: broadcast_id],
      call: {CustomerIo.App.Broadcasts, :get_broadcast},
  ...
  def get_broadcast_action(broadcast_id, action_id, opts \\ []) do
    ...
    client.request(%{
      args: [broadcast_id: broadcast_id, action_id: action_id],
      call: {CustomerIo.App.Broadcasts, :get_broadcast_action},
  ...
  def list_broadcast_triggers(broadcast_id, opts \\ []) do
    ...
    client.request(%{
      args: [broadcast_id: broadcast_id],
      call: {CustomerIo.App.Broadcasts, :list_broadcast_triggers},
  ...
  def list_broadcasts(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {CustomerIo.App.Broadcasts, :list_broadcasts},
      url: "/v1/broadcasts",
      method: :get,
      response: [{200, :map}, {429, :null}],
      opts: opts
  ...
  def update_broadcast_action(broadcast_id, action_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {CustomerIo.App.Broadcasts, :update_broadcast_action},
      url: "/v1/broadcasts/#{broadcast_id}/actions/#{action_id}",
      body: body,
      method: :put,
      request: [
