defmodule CustomerIo.App.Segments do
  @moduledoc """
  ...
  def create_man_segment(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {CustomerIo.App.Segments, :create_man_segment},
      url: "/v1/segments",
      body: body,
      method: :post,
  ...
  def delete_man_segment(segment_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {CustomerIo.App.Segments, :delete_man_segment},
  ...
  def get_segment(segment_id, opts \\ []) do
    ...
    client.request(%{
      args: [segment_id: segment_id],
      call: {CustomerIo.App.Segments, :get_segment},
      url: "/v1/segments/#{segment_id}",
      method: :get,
  ...
  def get_segment_count(segment_id, opts \\ []) do
    ...
    client.request(%{
      args: [segment_id: segment_id],
      call: {CustomerIo.App.Segments, :get_segment_count},
  ...
  def get_segment_dependencies(segment_id, opts \\ []) do
    ...
    client.request(%{
      args: [segment_id: segment_id],
      call: {CustomerIo.App.Segments, :get_segment_dependencies},
  ...
  **If your workspace does not use email as a unique identifier** for people, `identifiers` does not contain `email` values. Go to your [Workspace Settings](/docs/workspaces/#migrate-workspace) to find out which identifiers your workspace supports.
  ...
  @spec get_segment_membership(integer, keyword) ::
          {:ok, CustomerIo.App.EmailOrId.t() | CustomerIo.App.IdOnly.t()} | :error
  def get_segment_membership(segment_id, opts \\ []) do
    ...
    client.request(%{
      args: [segment_id: segment_id],
      call: {CustomerIo.App.Segments, :get_segment_membership},
      url: "/v1/segments/#{segment_id}/membership",
      method: :get,
      query: query,
      response: [
        {200, {:union, [{CustomerIo.App.EmailOrId, :t}, {CustomerIo.App.IdOnly, :t}]}},
        {404, :null},
        {429, :null}
      ],
      opts: opts
  ...
  def list_segments(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {CustomerIo.App.Segments, :list_segments},
      url: "/v1/segments",
      method: :get,
