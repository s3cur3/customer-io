defmodule CustomerIo.App.SenderIdentities do
  @moduledoc """
  ...
  def get_sender(sender_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {CustomerIo.App.SenderIdentities, :get_sender},
  ...
  def get_sender_usage(sender_id, opts \\ []) do
    ...
    client.request(%{
      args: [sender_id: sender_id],
      call: {CustomerIo.App.SenderIdentities, :get_sender_usage},
  ...
  def list_senders(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {CustomerIo.App.SenderIdentities, :list_senders},
