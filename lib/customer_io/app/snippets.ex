defmodule CustomerIo.App.Snippets do
  @moduledoc """
  ...
  def delete_snippet(snippet_name, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {CustomerIo.App.Snippets, :delete_snippet},
  ...
  def list_snippets(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {CustomerIo.App.Snippets, :list_snippets},
      url: "/v1/snippets",
      method: :get,
      response: [{200, :map}],
      opts: opts
  ...
  def update_snippets(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {CustomerIo.App.Snippets, :update_snippets},
      url: "/v1/snippets",
      body: body,
      method: :put,
