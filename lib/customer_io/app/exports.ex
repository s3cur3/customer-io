defmodule CustomerIo.App.Exports do
  @moduledoc """
  ...
  def download_export(export_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {CustomerIo.App.Exports, :download_export},
  ...
  @spec export_deliveries_data(
          CustomerIo.App.Action.t()
          | CustomerIo.App.Campaign.t()
          | CustomerIo.App.Newsletter.t()
          | CustomerIo.App.TransactionalMessage.t(),
          keyword
        ) :: {:ok, map} | :error
  def export_deliveries_data(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {CustomerIo.App.Exports, :export_deliveries_data},
  ...
  def export_people_data(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {CustomerIo.App.Exports, :export_people_data},
  ...
  def get_export(export_id, opts \\ []) do
    ...
    client.request(%{
      args: [export_id: export_id],
      call: {CustomerIo.App.Exports, :get_export},
  ...
  def list_exports(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {CustomerIo.App.Exports, :list_exports},
      url: "/v1/exports",
      method: :get,
