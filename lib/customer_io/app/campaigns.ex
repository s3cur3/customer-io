defmodule CustomerIo.App.Campaigns do
  @moduledoc """
  ...
  def campaign_action_links(campaign_id, action_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {CustomerIo.App.Campaigns, :campaign_action_links},
  ...
  def campaign_action_metrics(campaign_id, action_id, opts \\ []) do
    ...
    client.request(%{
      args: [campaign_id: campaign_id, action_id: action_id],
      call: {CustomerIo.App.Campaigns, :campaign_action_metrics},
  ...
  def campaign_journey_metrics(campaign_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {CustomerIo.App.Campaigns, :campaign_journey_metrics},
  ...
  def campaign_link_metrics(campaign_id, opts \\ []) do
    ...
    client.request(%{
      args: [campaign_id: campaign_id],
      call: {CustomerIo.App.Campaigns, :campaign_link_metrics},
  ...
  def campaign_metrics(campaign_id, opts \\ []) do
    ...
    client.request(%{
      args: [campaign_id: campaign_id],
      call: {CustomerIo.App.Campaigns, :campaign_metrics},
  ...
  def get_campaign_action(campaign_id, action_id, opts \\ []) do
    ...
    client.request(%{
      args: [campaign_id: campaign_id, action_id: action_id],
      call: {CustomerIo.App.Campaigns, :get_campaign_action},
  ...
  def get_campaign_messages(campaign_id, opts \\ []) do
    ...
    client.request(%{
      args: [campaign_id: campaign_id],
      call: {CustomerIo.App.Campaigns, :get_campaign_messages},
  ...
  def get_campaigns(campaign_id, opts \\ []) do
    ...
    client.request(%{
      args: [campaign_id: campaign_id],
      call: {CustomerIo.App.Campaigns, :get_campaigns},
  ...
  def list_campaign_actions(campaign_id, opts \\ []) do
    ...
    client.request(%{
      args: [campaign_id: campaign_id],
      call: {CustomerIo.App.Campaigns, :list_campaign_actions},
  ...
  def list_campaigns(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {CustomerIo.App.Campaigns, :list_campaigns},
      url: "/v1/campaigns",
      method: :get,
  ...
  @spec update_campaign_action(
          integer,
          integer,
          CustomerIo.App.EmailMessage.t() | CustomerIo.App.Webhook.t(),
          keyword
        ) :: {:ok, CustomerIo.App.EmailMessage.t() | CustomerIo.App.Webhook.t()} | :error
  def update_campaign_action(campaign_id, action_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {CustomerIo.App.Campaigns, :update_campaign_action},
      url: "/v1/campaigns/#{campaign_id}/actions/#{action_id}/language/:language",
      body: body,
      method: :put,
      query: query,
      request: [
        {"application/json",
         {:union, [{CustomerIo.App.EmailMessage, :t}, {CustomerIo.App.Webhook, :t}]}}
      ],
      response: [
        {200, {:union, [{CustomerIo.App.EmailMessage, :t}, {CustomerIo.App.Webhook, :t}]}},
        {400, :null},
        {404, :null},
        {429, :null}
      ],
