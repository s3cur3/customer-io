defmodule CustomerIo.App.Collections do
  @moduledoc """
  ...
  **Note**: A collection cannot be more than 10 MB in size. No individual row in the collection can be more than 10 KB.
  ...
  """
  @spec add_collection(CustomerIo.App.DataByUrl.t() | CustomerIo.App.LocalData.t(), keyword) ::
          {:ok, map} | :error
  def add_collection(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {CustomerIo.App.Collections, :add_collection},
      url: "/v1/collections",
      body: body,
      method: :post,
      request: [
        {"application/json",
         {:union, [{CustomerIo.App.DataByUrl, :t}, {CustomerIo.App.LocalData, :t}]}}
      ],
  ...
  def delete_collection(collection_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {CustomerIo.App.Collections, :delete_collection},
  ...
  def get_collection(collection_id, opts \\ []) do
    ...
    client.request(%{
      args: [collection_id: collection_id],
      call: {CustomerIo.App.Collections, :get_collection},
      url: "/v1/collections/#{collection_id}",
      method: :get,
  ...
  def get_collection_contents(collection_id, opts \\ []) do
    ...
    client.request(%{
      args: [collection_id: collection_id],
      call: {CustomerIo.App.Collections, :get_collection_contents},
  ...
  def get_collections(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {CustomerIo.App.Collections, :get_collections},
      url: "/v1/collections",
      method: :get,
  ...
  * A collection cannot be more than 10 MB in size. No individual row in the collection can be more than 10 KB.
  ...
  @spec update_collection(
          integer,
          CustomerIo.App.DataByUrl.t() | CustomerIo.App.LocalData.t(),
          keyword
        ) ::
          {:ok, map} | :error
  def update_collection(collection_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {CustomerIo.App.Collections, :update_collection},
      url: "/v1/collections/#{collection_id}",
      body: body,
      method: :put,
      request: [
  ...
  **Note**: A collection cannot be more than 10 MB in size. No individual row in the collection can be more than 10 KB.
  ...
  def update_collection_contents(collection_id, body, opts \\ []) do
    ...
    client.request(%{
      args: [collection_id: collection_id, body: body],
      call: {CustomerIo.App.Collections, :update_collection_contents},
      url: "/v1/collections/#{collection_id}/content",
      body: body,
      method: :put,
