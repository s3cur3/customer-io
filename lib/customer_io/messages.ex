defmodule CustomerIo.Messages do
  @moduledoc """
  ...
  def get_archived_message(message_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {CustomerIo.Messages, :get_archived_message},
  ...
  def get_message(message_id, opts \\ []) do
    ...
    client.request(%{
      args: [message_id: message_id],
      call: {CustomerIo.Messages, :get_message},
  ...
  def list_messages(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {CustomerIo.Messages, :list_messages},
      url: "/v1/messages",
      method: :get,
      query: query,
