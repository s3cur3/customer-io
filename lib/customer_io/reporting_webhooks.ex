defmodule CustomerIo.ReportingWebhooks do
  @moduledoc """
  ...
  def create_webhook(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {CustomerIo.ReportingWebhooks, :create_webhook},
  ...
  def delete_webhook(webhook_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {CustomerIo.ReportingWebhooks, :delete_webhook},
  ...
  def get_webhook(webhook_id, opts \\ []) do
    ...
    client.request(%{
      args: [webhook_id: webhook_id],
      call: {CustomerIo.ReportingWebhooks, :get_webhook},
      url: "/v1/reporting_webhooks/#{webhook_id}",
      method: :get,
  ...
  def list_webhooks(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {CustomerIo.ReportingWebhooks, :list_webhooks},
      url: "/v1/reporting_webhooks",
      method: :get,
  ...
  def update_webhook(webhook_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {CustomerIo.ReportingWebhooks, :update_webhook},
      url: "/v1/reporting_webhooks/#{webhook_id}",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
