defmodule CustomerIo.SendMessages do
  @moduledoc """
  ...
  """
  @spec send_email(CustomerIo.WithTemplate.t() | CustomerIo.WithoutTemplate.t(), keyword) ::
          {:ok, map} | {:error, map}
  def send_email(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {CustomerIo.SendMessages, :send_email},
      url: "/v1/send/email",
      body: body,
      method: :post,
      request: [
        {"application/json",
         {:union, [{CustomerIo.WithTemplate, :t}, {CustomerIo.WithoutTemplate, :t}]}}
      ],
  ...
  def send_push(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {CustomerIo.SendMessages, :send_push},
      url: "/v1/send/push",
      body: body,
      method: :post,
  ...
  **This endpoint is rate-limited to one request every 10 seconds.** After exceeding this, you'll receive a status of 429. Broadcasts are optimized to send messages to a large audience and not for one-to-one interactions. Use our [transactional API](#send-email) or event-triggered campaigns to respond to your audience on an individual, one-to-one basis.
  ...
  @spec trigger_broadcast(
          integer,
          CustomerIo.CustomRecipients.t()
          | CustomerIo.DataFileUrl.t()
          | CustomerIo.DefaultAudience.t()
          | CustomerIo.Emails.t()
          | CustomerIo.Ids.t()
          | CustomerIo.UserMaps.t(),
          keyword
        ) :: {:ok, map} | {:error, map}
  def trigger_broadcast(broadcast_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {CustomerIo.SendMessages, :trigger_broadcast},
