defmodule CustomerIo.Newsletters do
  @moduledoc """
  ...
  def get_newsletter_links(newsletter_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {CustomerIo.Newsletters, :get_newsletter_links},
  ...
  def get_newsletter_metrics(newsletter_id, opts \\ []) do
    ...
    client.request(%{
      args: [newsletter_id: newsletter_id],
      call: {CustomerIo.Newsletters, :get_newsletter_metrics},
  ...
  def get_newsletter_msg_meta(newsletter_id, opts \\ []) do
    ...
    client.request(%{
      args: [newsletter_id: newsletter_id],
      call: {CustomerIo.Newsletters, :get_newsletter_msg_meta},
  ...
  def get_newsletter_variant(newsletter_id, content_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {CustomerIo.Newsletters, :get_newsletter_variant},
  ...
  def get_newsletters(newsletter_id, opts \\ []) do
    ...
    client.request(%{
      args: [newsletter_id: newsletter_id],
      call: {CustomerIo.Newsletters, :get_newsletters},
  ...
  def get_variant_links(newsletter_id, content_id, opts \\ []) do
    ...
    client.request(%{
      args: [newsletter_id: newsletter_id, content_id: content_id],
      call: {CustomerIo.Newsletters, :get_variant_links},
  ...
  def get_variant_metrics(newsletter_id, content_id, opts \\ []) do
    ...
    client.request(%{
      args: [newsletter_id: newsletter_id, content_id: content_id],
      call: {CustomerIo.Newsletters, :get_variant_metrics},
  ...
  def list_newsletter_variants(newsletter_id, opts \\ []) do
    ...
    client.request(%{
      args: [newsletter_id: newsletter_id],
      call: {CustomerIo.Newsletters, :list_newsletter_variants},
  ...
  def list_newsletters(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {CustomerIo.Newsletters, :list_newsletters},
      url: "/v1/newsletters",
      method: :get,
      response: [{200, :map}],
      opts: opts
  ...
  def update_newsletter_variant(newsletter_id, content_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {CustomerIo.Newsletters, :update_newsletter_variant},
      url: "/v1/newsletters/#{newsletter_id}/contents/#{content_id}",
      body: body,
      method: :put,
