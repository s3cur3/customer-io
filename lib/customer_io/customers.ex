defmodule CustomerIo.Customers do
  @moduledoc """
  ...
  def get_people_by_id(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {CustomerIo.Customers, :get_people_by_id},
  ...
  def get_people_email(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {CustomerIo.Customers, :get_people_email},
      url: "/v1/customers",
      method: :get,
      query: query,
  ...
  def get_people_filter(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {CustomerIo.Customers, :get_people_filter},
      url: "/v1/customers",
      body: body,
      method: :post,
      query: query,
  ...
  def get_person_activities(customer_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {CustomerIo.Customers, :get_person_activities},
  ...
  def get_person_attributes(customer_id, opts \\ []) do
    ...
    client.request(%{
      args: [customer_id: customer_id],
      call: {CustomerIo.Customers, :get_person_attributes},
  ...
  def get_person_messages(customer_id, opts \\ []) do
    ...
    client.request(%{
      args: [customer_id: customer_id],
      call: {CustomerIo.Customers, :get_person_messages},
  ...
  def get_person_relationships(customer_id, opts \\ []) do
    ...
    client.request(%{
      args: [customer_id: customer_id],
      call: {CustomerIo.Customers, :get_person_relationships},
  ...
  def get_person_segments(customer_id, opts \\ []) do
    ...
    client.request(%{
      args: [customer_id: customer_id],
      call: {CustomerIo.Customers, :get_person_segments},
  ...
  def get_person_subscription_preferences(customer_id, opts \\ []) do
    ...
    client.request(%{
      args: [customer_id: customer_id],
      call: {CustomerIo.Customers, :get_person_subscription_preferences},
