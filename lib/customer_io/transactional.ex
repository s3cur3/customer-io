defmodule CustomerIo.Transactional do
  @moduledoc """
  ...
  def get_transactional(transactional_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {CustomerIo.Transactional, :get_transactional},
  ...
  def list_transactional(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {CustomerIo.Transactional, :list_transactional},
  ...
  def transactional_links(transactional_id, opts \\ []) do
    ...
    client.request(%{
      args: [transactional_id: transactional_id],
      call: {CustomerIo.Transactional, :transactional_links},
  ...
  def transactional_messages(transactional_id, opts \\ []) do
    ...
    client.request(%{
      args: [transactional_id: transactional_id],
      call: {CustomerIo.Transactional, :transactional_messages},
  ...
  def transactional_metrics(transactional_id, opts \\ []) do
    ...
    client.request(%{
      args: [transactional_id: transactional_id],
      call: {CustomerIo.Transactional, :transactional_metrics},
  ...
  def update_transactional(transactional_id, content_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {CustomerIo.Transactional, :update_transactional},
